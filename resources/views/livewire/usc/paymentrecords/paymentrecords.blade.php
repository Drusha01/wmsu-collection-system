                    ...
                    <nav class="flex px-5 py-3 text-gray-700" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <a href="{{ route('usc-paymentrecords')}}" class="flex items-center">
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        <div class="w-full md:w-3/4 flex">
                            ...
                            <div class="flex items-center space-x-3 mx-4 ">
                                <select id="course" name="course" wire:model="table_filters.table_max_display" wire:change="updateTableMaxDisplay()"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    <option value="5" >5 rows </option>
                                    <option value="10" >10 rows </option>
                                    <option value="30" >30 rows </option>
                                    <option value="50" >30 rows </option>
                                </select>
                            </div>    
                        </div>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>         
                                @foreach ($payment_records_data as $key =>$value)              
                                    <tr wire:key="payment-record-{{$value->id}}" class="border-b dark:border-gray-700">
                                        @foreach($table_filters['filter_content']  as $filter_key =>$filter_value)
                                            @if($filter_value['active'])
                                                ...
                                                @elseif($filter_value['column'] == 'Amount Collected')
