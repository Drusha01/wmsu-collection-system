                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        <div class="w-full md:w-1/4">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" wire:model.live.debounce.250ms="filters.username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search username" required="">            
                            </div>
                        </div>
                            ...
                            <div class="relative w-8/12 max-w-6xl p-8 max-h-screen flex flex-col">
                                ...
                                <form action="#" wire:submit.prevent="saveCancelRemit({{$remit['id']}},'CancelRemitModal')">
                                    <div class="relative p-5 bg-white rounded-lg shadow dark:bg-gray-800 flex-1">
                                        ...
                                        <!-- Save Fees Button - Bottom Section -->
                                        <div class="mt-4 flex items-center justify-end dark:border-gray-600 p-2">
                                            <button data-modal-toggle="CancelRemitModal" class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 font-bold py-2 px-3 rounded">
                                                Back
                                            </button>
                                            <button type="submit"
