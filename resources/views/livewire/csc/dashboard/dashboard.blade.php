<div>
    ...
    <main class="p-9 sm:ml-64 pt-20 sm:pt-8 h-auto">
        <div class="p-4">
            ...
            <div class="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2 mb-4 mt-4 max-w-full">
                <div class="mb-10 content-center">
                    <div class="col-span-1 ml-4 p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        <div class="w-full">
            ...
            <div class="-mt-8 mr-4 content-center w-50">
                <div class="col-span-1 items-center justify-between p-4 bg-white border ml-4 border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                    <div class="w-full">
            ...
            <div class="mr-4 mt-8 content-center w-50">
