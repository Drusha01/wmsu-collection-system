    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
        ...
        <div class="mt-5">
            <div class="  relative  sm:rounded-lg overflow-hidden">
                <div class="grid grid-cols-1 gap-6 mb-4 mt-6 max-w-full">

                    <!-- Number of student enroleed -->
                    <div class=" col-span-1 items-center justify-between p-4 bg-white border ml-4 mr-4 border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        <div class="w-full">
                            <h3 class="text-base font-normal text-gray-900 dark:text-gray-400">Number of student enrolled</h3>
                            <span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">325</span>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1 mt-8  items-center justify-between p-4 bg-white border ml-4 mr-4 border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        <div class="w-full">
                            <h3 class="text-base font-normal text-gray-900 dark:text-gray-400">Number of paid students </h3>
