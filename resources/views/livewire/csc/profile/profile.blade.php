                                    ...
                                    <div>
                                        <div class="grid gap-6 mb-6 md:grid-cols-1 w-3/6">
                                            <div>
                                                ...
                                                <span id="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">csc21</span>
                                            </div>
                                            <div class="flex">
                                        ...
                                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                                            ...
                                            <div class="relative">
                                                ...
                                                <span id="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">csc-admin</span>
                                            </div>
                                            <div class="relative">
                                            ...
                                            <div class="relative">
                                                ...
                                                <span id="position" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">Mayor</span>
                                            </div>
                                        </div>
