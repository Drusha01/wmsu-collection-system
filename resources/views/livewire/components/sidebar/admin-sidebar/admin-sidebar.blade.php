    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        ...
        <ul class="space-y-4 font-medium">
            ...
            @if ($user_details->role_name == 'admin')
                ...
                <li>
                <a wire:navigate href="{{route('admin-dashboard')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{ Route::is('admin-dashboard') ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                ...
                <!--Admin Payments -->
                <li>
                <a wire:navigate href="{{route('admin-payments')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{ Route::is('admin-payments') ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                ...
                <li>
                <a wire:navigate href="{{route('admin-paymentrecords')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{ Route::is('admin-paymentrecords') ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                ...
                <!-- Admin Remits -->
                <li>
                    <a wire:navigate href="{{route('admin-remitrecords')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                        {{ Route::is('admin-remitrecords') ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                ...
                <!-- Admin Students -->
                <li>
                    <a wire:navigate href="{{route('admin-enrolledstudents')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                        {{ Route::is('admin-enrolledstudents')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                ...
                <li>
                    <a wire:navigate href="{{route('admin-students')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                ...
                <!-- Admin Colleges -->
                <li>
                <a wire:navigate href="{{route('admin-colleges')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{ Route::is('admin-colleges')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                ...
                <!-- Admin Audit Log -->
                <li>
                    <a wire:navigate href="{{route('admin-auditlogs')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                        {{ Route::is('admin-auditlogs')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                ...
                <li>
                    <a wire:navigate href="{{route('admin-systemlogs')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                        {{ Route::is('admin-systemlogs')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5h8m-1-3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1m6 0v3H6V2m6 0h4a1 1 0 0 1 1 1v15a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h4m0 9.464 2.025 1.965L12 9.571"/>
                        </svg>
            ...
            @elseif ($user_details->role_name == 'officer')
                ...
                <li>
                <a wire:navigate href="{{route('officer-dashboard')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{ Route::is('officer-dashboard')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 21">
                        <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                        <path d="M9 4.025A7.5 7.5 0 1 0 16.975 12H9V4.025Z"/>
                        <path d="M12.5 1c-.169 0-.334.014-.5.025V9h7.975c.011-.166.025-.331.025-.5A7.5 7.5 0 0 0 12.5 1Z"/>
                ...
                <!--Officer Payments -->
                <li>
                <a wire:navigate href="{{ route('officer-payments')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{ Route::is('officer-payments')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 2a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1M2 5h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm8 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"/>
                    </svg>
                    <span class="ms-3">Payments</span>
                ...
                <li>
                <a wire:navigate href="{{ route('officer-paymentrecords')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{ Route::is('officer-paymentrecords')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5h8m-1-3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1m6 0v3H6V2m6 0h4a1 1 0 0 1 1 1v15a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h4m0 9.464 2.025 1.965L12 9.571"/>
                    </svg>
                    <span class="ms-3">Payment Records</span>
                ...
                <!--Officer Students -->
                <li>
                <a wire:navigate href="{{ route('officer-students')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
            ...
            @elseif ($user_details->role_name == 'collector')
                ...
                <li>
                <a wire:navigate href="{{route('collector-dashboard')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{ Route::is('collector-dashboard')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 21">
                        <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                        <path d="M9 4.025A7.5 7.5 0 1 0 16.975 12H9V4.025Z"/>
                        <path d="M12.5 1c-.169 0-.334.014-.5.025V9h7.975c.011-.166.025-.331.025-.5A7.5 7.5 0 0 0 12.5 1Z"/>
                ...
                <li>
                <a wire:navigate href="{{ route('collector-payments')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{  Route::is('collector-payments')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 2a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1M2 5h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm8 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"/>
                    </svg>
                    <span class="ms-3">Payments</span>
                ...
                <li>
                <a wire:navigate href="{{ route('collector-paymentrecords')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
                    {{  Route::is('collector-paymentrecords')   ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5h8m-1-3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1m6 0v3H6V2m6 0h4a1 1 0 0 1 1 1v15a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h4m0 9.464 2.025 1.965L12 9.571"/>
                    </svg>
                    <span class="ms-3">Payment Records</span>
                ...
                <!--Collector Students -->
                <li>
                <a wire:navigate href="{{ route('collector-students')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group 
            ...
            <li>
                ...
                <ul id="admin-settings-dropdown" class="py-2 space-y-2">
                    ...
                    @if ($user_details->role_name == 'admin')
                        <li>
                            <a wire:navigate href="{{route('admin-overview')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 
                            {{ Route::is('admin-overview') ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                            Overview
                            </a>
                        </li>
                        <li>
                            <a wire:navigate href="{{route('admin-fees')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 
                            {{ Route::is('admin-fees')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                            Fees
                            </a>
                        </li>
                        <li>
                            <a wire:navigate href="{{route('admin-usermanagement')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 
                            {{ Route::is('admin-usermanagement')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                            User Management
                            </a>
                        </li>
                    <!-- Officer Settings -->
                    @elseif ($user_details->role_name == 'officer')
                        <li>
                            <a wire:navigate href="{{route('officer-fees')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 
                            {{ Route::is('officer-fees')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                            Fees
                            </a>
                        </li>
                        <li>
                            <a wire:navigate href="{{route('officer-usermanagement')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 
                            {{ Route::is('officer-usermanagement')  ? 'bg-red-200 hover:bg-red-200 pointer-events-none' : '' }}">
                            User Management
                            </a>
                        </li>
                    <!-- Collector Settings -->
            ...
            <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                <li>
                    <a wire:navigate href="{{ route('logout') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
